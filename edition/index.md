...
<script>
  ...
  document
  .querySelectorAll(
  "tei-change[data-authorial='true']",
  )
  .forEach((rdg) => {
  ...
  const apps = document.querySelectorAll("tei-change");

      apps.forEach((app) => {
        const rdgs = Array.from(app.querySelectorAll("tei-change"));
  ...
  CLEAN_MODE = false;
      ...
      document.querySelectorAll("tei-add[place]").forEach((add) => {
        const parentRdg = add.closest("tei-change");
  ...
  CLEAN_MODE = true;
      ...
      const apps = document.querySelectorAll("tei-change");
      apps.forEach((app) => {
        const rdgs = app.querySelectorAll("tei-change");
        const lems = app.querySelectorAll("tei-change");
        rdgs.forEach((rdg) => {
          rdg.style.display = "none";
        });
        lems.forEach((lem) => {
  ...
  document.querySelectorAll("tei-change").forEach((el) => {
